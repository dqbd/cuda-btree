...
\begin{figure}
  ...
  \caption{Comparison between a typical CPU vs GPU structure, the main difference being the increased amount of computing cores. \cite{cudaprog}}
...
\begin{figure}[H]
  ...
  \caption{Architecture of an Ampere GA10x Streaming Multiprocessor with RT cores for accelerated raytracing. \cite{nvidiaampere}}
